 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fi=new wl("@firebase/app"),MC="@firebase/app-compat",FC="@firebase/analytics-compat",UC="@firebase/analytics",VC="@firebase/app-check-compat",BC="@firebase/app-check",$C="@firebase/auth",qC="@firebase/auth-compat",jC="@firebase/database",zC="@firebase/database-compat",HC="@firebase/functions",KC="@firebase/functions-compat",WC="@firebase/installations",GC="@firebase/installations-compat",YC="@firebase/messaging",QC="@firebase/messaging-compat",XC="@firebase/performance",JC="@firebase/performance-compat",ZC="@firebase/remote-config",ex="@firebase/remote-config-compat",tx="@firebase/storage",nx="@firebase/storage-compat",rx="@firebase/firestore",ix="@firebase/firestore-compat",sx="firebase",ox="9.14.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ix(t){er(new sn("platform-logger",e=>new OC(e),"PRIVATE")),er(new sn("heartbeat",e=>new wx(e),"PRIVATE")),rn(Ed,Qg,t),rn(Ed,Qg,"esm2017"),rn("fire-js","")}Ix("");const Ex=Object.freeze(Object.defineProperty({__proto__:null,SDK_VERSION:Yr,_DEFAULT_ENTRY_NAME:Mr,_addComponent:ku,_addOrOverwriteComponent:Wb,_apps:Fr,_clearComponents:ux,_components:wa,_getProvider:Gb,_registerComponent:er,_removeServiceInstance:cx,deleteApp:Yb,getApp:dx,getApps:fx,initializeApp:$f,onLog:Qb,registerVersion:rn,setLogLevel:Xb,FirebaseError:Tt},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function MR(t,e,n){const r=H(t),i={requestType:"EMAIL_SIGNIN",email:e};P(n.handleCodeInApp,r,"argument-error"),n&&kl(r,i,n),await dR(r,i)}function FR(t,e){const n=Il.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function UR(t,e,n){const r=H(t),i=Qr.credentialWithLink(e,n||_a());return P(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),Tl(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XF(t){return t!==void 0}function JF(t){return typeof t=="function"}function ZF(t){return typeof t=="object"&&!Array.isArray(t)}function uh(t){return typeof t=="string"||t instanceof String}function Uv(t){return Ep()&&t instanceof Blob}function Ep(){return typeof Blob<"u"&&!vl()}function rf(t,e,n,r){if(r<e)throw Ls(`Invalid value for '${t}'. Expected ${e} or greater.`);if(r>n)throw Ls(`Invalid value for '${t}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
